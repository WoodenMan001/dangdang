...
* @Last Modified time: 2018-05-20 22:58:40
*/
		...
		init: function($) {
		  ...
		  function loading_lunbo(list_lunbo) {
		  		...
		  		$(list_lunbo).each(function(i){
		  			...
		  			if(i ==0 ){
		  				oli = `
							<li style='position: absolute; opacity: 1; z-index: 9;'>
		                    	<a class=" pic" >
		                    		<img src="${url}" >
		                    	</a> 
		                    </li>`;
		             ...
		             if(i==0){
		            	...
		            	oIndexLi = `<li class="">${i}</li>`
		  				...
		  				oli = `
							<li style='position: absolute; opacity: 0; z-index: 1;'>
		                    	<a class=" pic" >
		                    		<img src="${url}" >
		                    	</a> 
		                    </li>`;
